...
def main():
    ...
    if st.button("Calcular"):
        ...
        df_total = df_prev.iloc[:, 1:] + df_inv.iloc[:, 1:]  # Soma apenas da segunda coluna em diante
        df_total.insert(0, df_prev.columns[0], df_inv.iloc[:, 0])  # Mantém a primeira coluna original
